...
class Tim_Tauron_ComplaintController extends Mage_Core_Controller_Front_Action
{
    public function checkOrderAction()
    {
        ...
        $entityId = Mage::getModel('sales/order')->loadByIncrementId($postData['orderNumber'])->getEntityId();
        ...
        foreach ($orderItems as $item) {
            ...
            $productsInfo[$i]['name'] = Mage::getModel("catalog/product")->load($item->product_id)->getName();
            $i++;
        }
